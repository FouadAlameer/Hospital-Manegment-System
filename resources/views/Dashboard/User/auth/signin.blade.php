                                    ...
                                    <div class="card-sigin">
                                        <div class="main-signup-header">
                                            ...
                                            <div class="form-group">
                                                <label
                                                    for="exampleFormControlSelect1">{{ trans('Dashboard/login_trans.select Enter') }}</label>
                                                <select class="form-control" id="sectionChooser">
                                                    <option value="" selected disabled>
                                                        {{ trans('Dashboard/login_trans.Choose List') }}</option>
                                            ...
                                            <div class="loginform" id="user">
                                                ...
                                                <h5 class="font-weight-semibold mb-4">
                                                    {{ trans('Dashboard/login_trans.User') }}</h5>
                                            ...
                                            <div class="loginform" id="admin">
												Admin
                                                <h5 class="font-weight-semibold mb-4">
                                                    {{ trans('Dashboard/login_trans.Admin') }}</h5>
