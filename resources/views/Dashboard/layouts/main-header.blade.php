                		...
                		<a href="#" class="d-flex nav-item nav-link pl-0 country-flag" data-toggle="dropdown"
                    		...
                    		@if (App::getLocale() == 'ar')
                        		<span class="avatar country-flag mr-0 align-self-center bg-transparent">
                            		<img src="{{ URL::asset('Dashboard/img/flags/egypt.png') }}" alt="img"></span>
                        		{{-- <strong
						 			class="mr-2 m-2 my-auto">{{ \Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocaleName() }}</strong> --}}
                    		@else
                        		<span class="avatar country-flag mr-0 align-self-center bg-transparent"><img
							 	src="{{ URL::asset('Dashboard/img/flags/us_flag.jpg') }}" alt="img"></span>
                        		{{-- <strong
						 		class="mr-2 ml-2 my-auto">{{ \Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocaleName() }}</strong> --}}
                    		@endif
                		</a>
                		<div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow x-placement="bottom-end">
                    		...
                    		@foreach(\Mcamara\LaravelLocalization\Facades\LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                        		...
                        		<a class="dropdown-item" rel="alternate" hreflang="{{ $localeCode }}" 
                            		...
                            		@elseif ($properties['native'] == 'العربيه')
									...
									@endif
										...
										<a class="dropdown-item" href="route('logout')"
												onclick="event.preventDefault();
															this.closest('form').submit();"><i class="bx bx-slider-alt"></i> تسجيل خروج</a>
